...
If ItemName <> "" Then
    ...
    'Tireden sonraki harfler büyük. Tireden önce ve sonra boþluk ekle.
    If InStr(ItemName, "-") <> 0 Then
        ...
        If Kisaltma = " X2" Then
            Kisaltma = " X2"
        Else
            Kisaltma = UCase(Replace(Replace(Kisaltma, "ý", "I"), "i", "I"))
        End If
...
support_item_types_UI.BackColor = RGB(230, 230, 230) 'YENÝ
