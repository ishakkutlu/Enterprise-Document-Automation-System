...
If ItemName <> "" Then
    ...
    ItemName = LCase(Replace(Replace(ItemName, "I", "i"), "I", "ý"))
...
''Oluþan boþ satýr arada ise boþ satýrý kaldýr.
...
support_submission_purposes_UI.BackColor = RGB(230, 230, 230) 'YENÝ
